 ...
 * searching for {@link Taxonomy taxonomies}.
 * 
 ...
 * 
 */
public interface TaxonomyCriteria extends CmsCriteria {

	/**
	 * Adds a criterion with {@link QueryOperator#EQUALS equals} operator for
	 * {@link Taxonomy#getName() name}.
	 *
	 * @param taxonomyName
	 * 			Taxonomy name.
	 */
	void addNameEqualsCriterion(String taxonomyName);
