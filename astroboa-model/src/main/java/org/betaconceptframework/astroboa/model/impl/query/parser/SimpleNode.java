...
public class SimpleNode implements Node {
  ...
  protected CriterionParser parser;

  public SimpleNode(int i) {
    id = i;
  }

  public SimpleNode(CriterionParser p, int i) {
    this(i);
    parser = p;
  }
  ...
  public String toString() { return CriterionParserTreeConstants.jjtNodeName[id]; }
...
/* JavaCC - OriginalChecksum=cefbd65b7fb6ffb51a9a39ff0be244a3 (do not edit this line) */
