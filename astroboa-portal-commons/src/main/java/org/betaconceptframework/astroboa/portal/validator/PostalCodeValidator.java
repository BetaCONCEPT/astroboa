...
@BypassInterceptors
@Validator(id="postalCodeValidator")
public class PostalCodeValidator implements javax.faces.validator.Validator {
	...
	public void validate(FacesContext context, UIComponent component,
		...
		logger.info("PostalCodeValidator.validate called");
		try {
			if (!validPostalCode((String)value)) {
				String validatorMessage = JSFUtilities.getStringI18n("validator.postalCode");
	...
	private boolean validPostalCode(String value) {
		return StringUtils.isBlank(value) || 
			CommonRegularExpressions.COMPILED_POSTAL_CODE_PATTERN.matcher(value).matches();
	}
}
