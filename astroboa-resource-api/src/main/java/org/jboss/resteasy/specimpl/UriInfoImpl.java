      ...
      for (String param : params)
      {
         if (param.indexOf('=') >= 0)
         {
        	//String[] nv = param.split("=");
         	...
         	//Added by BetaCONCEPT
         	 //If parameter is split by '=' 
         	 //as is done above in the commented split command (original code) then
         	 //in case parameter value contains '='
         	 //split will provide more than two 
         	 //parts which is wrong. What we want is the following
             String[] nv = new String[]{StringUtils.substringBefore(param, "="), 
