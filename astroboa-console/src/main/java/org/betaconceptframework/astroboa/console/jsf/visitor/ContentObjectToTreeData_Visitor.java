 ...
 * 
 */
public class ContentObjectToTreeData_Visitor extends AbstractCmsPropertyDefinitionVisitor{

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private ContentObjectUIWrapper contentObjectUIWrapper;
	private TreeNode contentObjectAsTreeData;
	private TreeNode currentlyVisitedTreeNodeParent;
	private String locale;
	
	public ContentObjectToTreeData_Visitor(ContentObjectUIWrapper contentObjectUIWrapper) {
	...
	public void visit(ContentObjectTypeDefinition contentObjectTypeDefinition) {
		...
		contentObjectAsTreeData = new TreeNodeImpl();
	...
	public <T> void visitSimplePropertyDefinition(
		...
		addTreeNodeForSimpleProperty(simplePropertyDefinition);
		
	}

	private void addTreeNodeForSimpleProperty(SimpleCmsPropertyDefinition propertyDefinition)
	{
