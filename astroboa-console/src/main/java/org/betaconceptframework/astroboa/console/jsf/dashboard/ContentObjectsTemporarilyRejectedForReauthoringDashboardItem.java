 ...
 * 
 */
@Name("contentObjectsTemporarilyRejectedForReauthoringDashboardItem")
@Scope(ScopeType.CONVERSATION)
public class ContentObjectsTemporarilyRejectedForReauthoringDashboardItem extends ContentObjectListBean{
	...
	public ContentObjectDataModel getReturnedContentObjects() {
		if (super.getReturnedContentObjects() == null){
			...
			try {
				...
				Criterion statusCriterion = CriterionFactory.equals("profile.contentObjectStatus", "temporarilyRejectedForReauthoring");
