...
EditAreaLoader.prototype ={
	...
	*/	
	...
	// astroboa custom code for preparing all the textareas replaced by an editarea to be submited
	// it needs the form into which the text areas reside
	prepare_areas_for_betacms_submit : function(formid){		
		var formObj,is_child,fs=window.frames,i,x;
