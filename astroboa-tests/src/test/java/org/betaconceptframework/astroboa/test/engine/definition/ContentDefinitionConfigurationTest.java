...
public class ContentDefinitionConfigurationTest  extends AbstractRepositoryTest{
	...
	public void testExtendedContentTypes()
	{
		...
		ContentObjectTypeDefinition directExtendedTestDefinition = definitionService.getContentObjectTypeDefinition(DIRECT_EXTENDED_TEST_CONTENT_TYPE);
		...
		ContentObjectTypeDefinition personDefinition = definitionService.getContentObjectTypeDefinition("personObject");
	...
	public void testAcceptedContentTypes(){
		...
		ContentObjectPropertyDefinition referenceOfAnyContentObjectOfTypeTestTypeDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".referenceOfAnyContentObjectOfTypeTestType");
		ContentObjectPropertyDefinition multipleReferenceOfAnyContentObjectOfTypeTestTypeDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".multipleReferenceOfAnyContentObjectOfTypeTestType");
		ContentObjectPropertyDefinition allPropertyContainerReferenceOfAnyContentObjectOfTypeTestTypeDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainer.referenceOfAnyContentObjectOfTypeTestType");
		ContentObjectPropertyDefinition allPropertyContainerMultipleReferenceOfAnyContentObjectOfTypeTestTypeDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainer.multipleReferenceOfAnyContentObjectOfTypeTestType");
		ContentObjectPropertyDefinition multipleAllPropertyContainerReferenceOfAnyContentObjectOfTypeTestTypeDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainerMultiple.referenceOfAnyContentObjectOfTypeTestType");
		ContentObjectPropertyDefinition multipleAllPropertyContainerMultipleReferenceOfAnyContentObjectOfTypeTestTypeDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainerMultiple.multipleReferenceOfAnyContentObjectOfTypeTestType");

		ContentObjectPropertyDefinition referenceOfAnyContentObjectOfTypeTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".referenceOfAnyContentObjectOfTypeTest");
		ContentObjectPropertyDefinition multipleReferenceOfAnyContentObjectOfTypeTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".multipleReferenceOfAnyContentObjectOfTypeTest");
		ContentObjectPropertyDefinition allPropertyContainerReferenceOfAnyContentObjectOfTypeTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainer.referenceOfAnyContentObjectOfTypeTest");
		ContentObjectPropertyDefinition allPropertyContainerMultipleReferenceOfAnyContentObjectOfTypeTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainer.multipleReferenceOfAnyContentObjectOfTypeTest");
		ContentObjectPropertyDefinition multipleAllPropertyContainerReferenceOfAnyContentObjectOfTypeTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainerMultiple.referenceOfAnyContentObjectOfTypeTest");
		ContentObjectPropertyDefinition multipleAllPropertyContainerMultipleReferenceOfAnyContentObjectOfTypeTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainerMultiple.multipleReferenceOfAnyContentObjectOfTypeTest");

		ContentObjectPropertyDefinition referenceOfAnyContentObjectOfTypeTestAndExtendedTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".referenceOfAnyContentObjectOfTypeTestAndExtendedTest");
		ContentObjectPropertyDefinition multipleReferenceOfAnyContentObjectOfTypeTestAndExtendedTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".multipleReferenceOfAnyContentObjectOfTypeTestAndExtendedTest");
		ContentObjectPropertyDefinition allPropertyContainerReferenceOfAnyContentObjectOfTypeTestAndExtendedTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainer.referenceOfAnyContentObjectOfTypeTestAndExtendedTest");
		ContentObjectPropertyDefinition allPropertyContainerMultipleReferenceOfAnyContentObjectOfTypeTestAndExtendedTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainer.multipleReferenceOfAnyContentObjectOfTypeTestAndExtendedTest");
		ContentObjectPropertyDefinition multipleAllPropertyContainerReferenceOfAnyContentObjectOfTypeTestAndExtendedTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainerMultiple.referenceOfAnyContentObjectOfTypeTestAndExtendedTest");
		ContentObjectPropertyDefinition multipleAllPropertyContainerMultipleReferenceOfAnyContentObjectOfTypeTestAndExtendedTestDefinition = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition(TEST_CONTENT_TYPE+".allPropertyTypeContainerMultiple.multipleReferenceOfAnyContentObjectOfTypeTestAndExtendedTest");
		...
		ContentObjectPropertyDefinition personJobPositionOrganizationObjectReference = (ContentObjectPropertyDefinition) definitionService.getCmsPropertyDefinition("personObject.organizations.jobPosition.organizationObjectReference");
	...
	private void checkAcceptedAndExpandedContentTypes(ContentObjectPropertyDefinition contentObjectPropertyDefinition, List<String> acceptedContentTypes, List<String> expandedContentTypes){
