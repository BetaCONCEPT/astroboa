...
public abstract class AbstractCmsDao {
	...
	protected CmsRepositoryEntityFactory cmsRepositoryEntityFactoryForActiveClient;

	public AbstractCmsDao() {
		super();
		this.cmsRepositoryEntityFactoryForActiveClient = CmsRepositoryEntityFactoryForActiveClient.INSTANCE.getFactory();
	}
