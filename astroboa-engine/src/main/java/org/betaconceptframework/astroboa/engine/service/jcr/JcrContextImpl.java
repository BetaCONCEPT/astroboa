...
import org.betaconceptframework.astroboa.engine.jcr.dao.JcrContextDao;
...
public class JcrContextImpl implements JcrContext{

	@Autowired
	private JcrContextDao jcrContextDao;
	
	@Transactional(readOnly = false, rollbackFor = CmsException.class)
	public Object executeCallback(JcrCallback jcrCallback)
			throws CmsException {
		return jcrContextDao.executeCallback(jcrCallback);
	}
